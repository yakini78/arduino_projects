...
void front(){
  digitalWrite(left_ctrl,HIGH);//set direction control pin of A motor to OUTPUT
  digitalWrite(left_pwm,HIGH);//set PWM control pin of A motor to OUTPUT
  digitalWrite(right_ctrl,HIGH);//set direction control pin of B motor to OUTPUT
  digitalWrite(right_pwm,HIGH);//set PWM control pin of B motor to OUTPUT
...
void forward()//define the status of going front
{
